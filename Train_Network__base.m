...
net_type = 0;    % 0 = LSTM Network 1 = Convolutional Neural Network 2 = ConvLSTM 3 = Feed Forward
...
numHiddenUnits=50; % parametro che rappresenta il numero di collegamenti tra le variabili (all'aumentare del parametro aumenta la rappresentazione dei picchi di concentrazione)
